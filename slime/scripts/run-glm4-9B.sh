...
CKPT_ARGS=(
   ...
   --load /data_storage/wyj/slime_export/ckpt/GLM-Z1-9B-0414_slime/
   --save /data_storage/wyj/slime_export/ckpt/GLM-Z1-9B-0414_slime/
   --save-interval 20
)
...
WANDB_ARGS=(
   ...
   --wandb-group test_slime_glm4-9B
   --wandb-key ${WANDB_KEY}
)
